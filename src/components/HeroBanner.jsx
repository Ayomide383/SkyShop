...
export default function HeroBanner({product}) {
  return (
    <div className="bg-gradient-to-r from-blue-50 via-blue-100 to-blue-50 py-8">
      <div className="mx-auto max-w-7xl px-6">
        
        <p className="text-xs text-gray-500">
          Home &gt; Shop &gt; {product?.category} &gt; <span className="font-medium text-gray-800">{product?.title}</span>
        </p>
        ...
        <div className="mt-4 flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            ...
            {/*} <p className="mt-1 text-sm text-gray-600">
              Experience crystal clear sound with our premium wireless headphones. Perfect for music, calls and more.
            </p>*/}
          </div>
